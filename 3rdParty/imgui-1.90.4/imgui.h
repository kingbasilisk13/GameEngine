...
enum ImGuiTreeNodeFlags_
{
    ...
    //ImGuiTreeNodeFlags_NoScrollOnOpen     = 1 << 15,  // FIXME: 
...
enum ImGuiHoveredFlags_
{
    ...
    //ImGuiHoveredFlags_AllowWhenBlockedByModal     = 1 << 6,   // Return true even if a modal popup window is normally blocking access to this item/window. FIXME-
...
struct ImGuiListClipper
{
    ...
    IMGUI_API void  IncludeItemsByIndex(int item_begin, int item_end) const;  // item_end is exclusive e.g. use (42, 42+1) to make item 42 never clipped.
